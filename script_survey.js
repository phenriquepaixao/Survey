...
const survey_parameters = {
    pt: `<div class="wrap-survey">
            <div class="article-survey">
                <div class="button-group" id="button-group">
                    <h3>O artigo foi útil?</h3>
                    <button class="article-survey-button" data-value="1" type="button" id="article-survey-button-yes">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" id="article-survey-button-yes"
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <button class="article-survey-button" data-value="0" type="button" id="article-survey-button-no">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" id="article-survey-button-no"
                            viewBox="0 0 16 16">
                            <path
                ...
                <div class="feedback-survey-dropdown" id="feedback-survey-dropdown">
                    <div class="header-feedback-survey-dropdown">
                        <h4>Qual é o motivo do seu feedback?</h4>
    ...
    en: `<div class="wrap-survey">
            <div class="article-survey">
                ...
                <div class="feedback-survey-dropdown" id="feedback-survey-dropdown">
                    <div class="header-feedback-survey-dropdown">
                        <h4>What is the reason for your feedback?</h4>
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16" id="close-feedback-survey-dropdown">
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                        </svg>
                    </div>
    ...
    es: `<div class="wrap-survey">
            <div class="article-survey">
                <div class="button-group" id="button-group">
                    <h3>¿Este artículo ha sido útil?</h3>
                    <button class="article-survey-button" data-value="1" type="button" id="article-survey-button-yes">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" id="article-survey-button-yes"
                            viewBox="0 0 16 16">
                            <path
                ...
                <div class="feedback-survey-dropdown" id="feedback-survey-dropdown">
                    <div class="header-feedback-survey-dropdown">
                        <h4>¿Cuál es el motivo de tus comentarios?</h4>
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16" id="close-feedback-survey-dropdown">
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                        </svg>
                    </div>
...
const section_survey = html_paragraphs_array.filter(text => text.innerText == '{{survey_confluence}}');
section_survey[0].insertAdjacentHTML('beforebegin', '<div class="container_survey"></div>');
section_survey[0].remove();
